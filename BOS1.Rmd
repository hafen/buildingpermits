---
title: "Housing Permit Data Summary: BOS1"
author: Ryan Hafen
output:
  packagedocs:
    toc: true
...
navpills: |
  ...
  <a id="study-drop" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false">Dataset (BOS1)<span class="caret"></span></a>
  <ul id="menu1" class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="study-drop">
  <li class='active'><a href='BOS1.html'>BOS1</a></li>
...
library(rbokeh)
library(knitr)
load("/var/folders/n4/6ztyqms165s3r_4n001n1y6m0000gn/T//RtmpvNpZPH/file421b191aa7ed")
```
