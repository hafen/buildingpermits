---
title: "Housing Permit Data Summary: MD1"
author: Ryan Hafen
output:
  packagedocs:
    toc: true
...
navpills: |
  ...
  <a id="study-drop" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false">Dataset (MD1)<span class="caret"></span></a>
  ...
  <li class='active'><a href='MD1.html'>MD1</a></li>
...
library(rbokeh)
library(knitr)
load("/var/folders/n4/6ztyqms165s3r_4n001n1y6m0000gn/T//RtmpvNpZPH/file421b2804cede")
```
...
```{r, echo=FALSE, message=FALSE, results='asis'}
vr <- di$var_summ[["applicationtype"]]
vr$artifacts$fg
```
...
```{r, echo=FALSE, message=FALSE, results='asis'}
vr <- di$var_summ[["declaredvaluation"]]
vr$artifacts$fg
```
