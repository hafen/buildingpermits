---
title: "Housing Permit Data Summary: MO7"
author: Ryan Hafen
output:
  packagedocs:
    toc: true
...
navpills: |
  ...
  <a id="study-drop" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false">Dataset (MO7)<span class="caret"></span></a>
  ...
  <li class='active'><a href='MO7.html'>MO7</a></li>
...
library(rbokeh)
library(knitr)
load("/var/folders/n4/6ztyqms165s3r_4n001n1y6m0000gn/T//RtmpvNpZPH/file421b502e0c5a")
```
...
```{r, echo=FALSE, message=FALSE, results='asis'}
vr <- di$var_summ[["property_description"]]
vr$artifacts$fg
```
