---
title: "Housing Permit Data Summary: IL2"
author: Ryan Hafen
output:
  packagedocs:
    toc: true
...
navpills: |
  ...
  <a id="study-drop" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false">Dataset (IL2)<span class="caret"></span></a>
  ...
  <li class='active'><a href='IL2.html'>IL2</a></li>
...
library(rbokeh)
library(knitr)
load("/var/folders/n4/6ztyqms165s3r_4n001n1y6m0000gn/T//RtmpvNpZPH/file421b2dc62a95")
```
...
```{r, echo=FALSE, message=FALSE, results='asis'}
vr <- di$var_summ[["permit_no_or_type"]]
vr$artifacts$fg
```
...
```{r, echo=FALSE, message=FALSE, results='asis'}
vr <- di$var_summ[["date_permit_issued"]]
vr$artifacts$fg
```
